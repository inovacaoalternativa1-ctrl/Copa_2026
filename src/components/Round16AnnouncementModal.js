...
const SEEN_KEY = 'copa_round16_announcement_seen_v1_';
...
export default function Round16AnnouncementModal() {
  const { user } = useAuth();
  ...
  return (
    <div className="la-overlay">
      ...
      <div className="la-modal">
        ...
        <h2 className="la-title">Chegaram as Oitavas de Final! ⚽</h2>
        <p className="la-text">
          O mata-mata chegou! Já dá pra palpitar nos 8 duelos das Oitavas —
          incluindo <strong>Brasil × Noruega</strong>, Portugal × Espanha,
          Argentina × Egito e muito mais. Cada palpite certo agora vale pontos no ranking!
        </p>
        <div className="la-kickoff-box">
          📅 Jogos de 4 a 7 de julho — veja os horários e garanta seus palpites!
        </div>
