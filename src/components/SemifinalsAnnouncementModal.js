...
const SEEN_KEY = 'copa_semifinals_announcement_seen_v1_';
...
export default function SemifinalsAnnouncementModal() {
  const { user } = useAuth();
  ...
  return (
    <div className="la-overlay">
      ...
      <div className="la-modal">
        ...
        <h2 className="la-title">Semifinais chegaram! 🔥</h2>
        <p className="la-text">
          Só 4 times restam na briga pelo título! Palpite nos 2 duelos —
          <strong> França × Espanha</strong> e <strong>Inglaterra × Argentina</strong>.
          Quem vai à grande final?
        </p>
        <div className="la-kickoff-box">
          📅 França × Espanha: 14/07 às 16h · Inglaterra × Argentina: 15/07 às 16h
        </div>
